function [net, opts] = initCaffe_masternet2(opts)
...
%{
	...
	CHANGELOG:
		-standard unet, looks for graphicscard and choses ips
%}
	...
	switch gpu_info.Name
		case 'GeForce GTX TITAN'
			opts.ips = [1,3,540, 540]; 
		case 'GeForce GTX TITAN X'
			opts.ips = [1,3,700, 700]; 
		otherwise
			opts.ips = [1,3,508,508]; %inputsize --> GTX970 4GB
	end
