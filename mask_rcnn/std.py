...
class StdConfig(Config):
    """Configuration for training on SingleTree Detecion Dataset.
...
class StdDataset(utils.Dataset):
    def load_std(self, dataset_dir):
        """Load the Single Tree Detection (STD) dataset.
        dataset_dir: The root directory of the STD dataset.
        """
